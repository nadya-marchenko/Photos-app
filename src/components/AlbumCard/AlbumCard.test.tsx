...
it("renders preview photos in album card", async () => {
  await act(async() => {
    const { getByAltText } = render(<AlbumCard link='test' title='Test link' previewPhotosNum={3} albumId={1} />);
    ...
    expect(getByAltText('reprehenderit est deserunt velit ipsam')).toHaveAttribute('src', 'https://via.placeholder.com/150/771796');
  })
}); 
